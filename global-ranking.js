...
document.addEventListener('DOMContentLoaded',()=>setTimeout(loadGlobalRanking,1800));
document.addEventListener('click',e=>{if(e.target.closest('#homeContestBtn,#homeQuizBtn,#homeGameBtn,#publishActionBtn'))setTimeout(loadGlobalRanking,1800)});
})();