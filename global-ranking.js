...
function setupMobileV2(){
  ...
  const openSearch=()=>{searchDrawer.classList.remove('hidden');setTimeout(()=>document.getElementById('filterDepartment')?.focus(),250)};const openRank=()=>{rankDrawer.classList.remove('hidden');loadGlobalRanking()};
